...
def sss(sec):
    rn = str(random.randrange(1, 100000000))
    sentences =\
        "Downloading the downloader",\
        "How's your day going?",\
        "Uninstalling the uninstaller (You're stuck with me)",\
        "Healing from a very minor case of serious brain damage",\
        "Defeating the enderdragon",\
        "Fleeing from Freddy Fazbear",\
        ...
        "Switching to the latest PS framework...",\
        ...
        r"You are number " + rn + " in the queue",\
    ...
    s3 = random.choice(sentences)
    s4 = random.choice(sentences)
    s5 = random.choice(sentences)
    s6 = random.choice(sentences)
    s7 = random.choice(sentences)
    s8 = random.choice(sentences)
    s9 = random.choice(sentences)
    s10 = random.choice(sentences)
    s11 = random.choice(sentences)
    s12 = random.choice(sentences)
    s13 = random.choice(sentences)
    s14 = random.choice(sentences)
    s15 = random.choice(sentences)
    s16 = random.choice(sentences)
    s17 = random.choice(sentences)
    s18 = random.choice(sentences)
    s19 = random.choice(sentences)
    s20 = random.choice(sentences)
    time.sleep(sec)
    print(s1)
    time.sleep(sec)
    print(s2)
